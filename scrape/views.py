...
def fetch_imagery():
	url = 'https://web.bet9ja.com/Sport/SubEventDetail?SubEventID=76996896'
...
def fetch_imager():
	url = 'https://www.betking.com/sports/s/event/p/soccer/simulated-reality-league/uefa-champions-league-srl/0/0'
	driver = webdriver.Chrome(r"c:/Users/SATYA/mysite/chromedriver")
	driver.get(url)
	driver.implicitly_wait(10) # seconds
	...
	button = driver.find_element_by_css_selector('td.oddItem.moreOdds.col-11')
	...
	row_list_list=[
	['betking.com',headings[0] , keys[0] , vals[0] , keys[1] , vals[1] , keys[2], vals[2]],
